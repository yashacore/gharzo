...
List<SingleChildWidget> appProviders = [
  ...
  ChangeNotifierProvider(create: (_) => BuilderDetailsProvider()),
  ChangeNotifierProvider(create: (_) => MyVisitProvider()),
  ChangeNotifierProvider(create: (_) => MyPropertiesProvider()),
  ChangeNotifierProvider(create: (_) => SubOwnerProvider()),
  ChangeNotifierProvider(create: (_) => SubOwnerDashboardProvider()),
