class ApiConstant {
  ...
  static const String sendOtp =
      "https://api.gharzoreality.com/api/auth/send-otp";
  static const String verifyOTP =
      "https://api.gharzoreality.com/api/auth/verify-otp";
  static const String registerUrl =
      "https://api.gharzoreality.com/api/auth/verify-otp";
  static const String resendOTP =
      "https://api.gharzoreality.com/api/auth/resend-otp";

  //-------------------Home
  static const String featuredProperties =
      "https://api.gharzoreality.com/api/public/properties/featured";

  static const String trendingProperties =
      "https://api.gharzoreality.com/api/public/properties/trending";

  static const String recentProperties =
      "https://api.gharzoreality.com/api/public/properties/recent";
